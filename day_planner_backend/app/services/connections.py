...
stay thin and this logic is reachable without an HTTP client. Errors are raised
as domain exceptions rather than HTTPException — the routes decide whether a
failure becomes a 409 with a machine-readable reason (the /internal callers) or
an HTML page (the browser-facing callback).
"""
...
from ..db.models import Calendar, ConnectedAccount
from ..db.store import Store
from ..providers import NeedsReauth, OAuthError, OAuthProvider
from . import crypto
