"""Request/response models for /internal/zones*.
...
Memory Bank. Same identity/no-path-parameter conventions as
../schemas/habits.py.
"""
...
# ../schemas/sleep_schedule.py can reuse the exact same rule rather than
# risking a second regex drifting out of sync with this one.
TIME_PATTERN = r"^([01]\d|2[0-3]):[0-5]\d$"


class CreateZoneRequest(InternalUserRequest):
...
class UpdateZoneRequest(InternalUserRequest):
