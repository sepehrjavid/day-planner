...
The habit/habit-session/zone/sleep-schedule routes that used to live here
(/internal/habits*, /internal/habit-sessions*, /internal/zones*,
/internal/sleep-schedule*) moved to day_planner_backend_app by A6.1 — see
docs/roadmaps/1-agent.md. This service now protects exactly four things:
connect-link, calendars, access-token, and disconnect — the credential
surface, not ordinary planning data.
"""
